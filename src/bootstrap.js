...
async function boot() {
  ...
  // Camera, attach the authored camera layer, then mount the selected venue before any
  // automatic director starts choosing shots.
  ...
  await loadScript('./src/venues/nocturne-calibration.js');

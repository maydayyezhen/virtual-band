...
async function boot() {
  ...
  // Keep the pre-venue virtual-band runtime intact. NOCTURNE phase 1 is mounted later as
  // an isolated application instead of sharing or patching this Scene/Renderer/Camera.
  ...
  await loadScript('./src/venues/nocturne-standalone-host.js');
}

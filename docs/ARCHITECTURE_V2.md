...
3. **Stable entity IDs.** Systems address instruments by IDs such as `drums.main`, `keyboard.main`, `violin.main` or `electric.2`. Object names are labels, not identity or routing logic.
